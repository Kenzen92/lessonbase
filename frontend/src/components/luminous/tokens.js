...
// Single source of truth for the app-wide Luminous look, ported verbatim from
// the Stitch DESIGN.md. Components read from `lumi` rather than inlining hex, so
// the palette can change in one place. These are intentionally kept separate
// from the app-wide MUI `darkTheme` used by the legacy auth screens.
