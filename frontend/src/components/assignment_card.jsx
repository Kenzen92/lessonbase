...
const AssignmentCard = ({ assignment, handleReloadData }) => {
    ...
    return (
        <Box sx={{ boxShadow: 2, borderColor: '#fff', borderRadius: "10px", borderStyle: 'solid', backgroundColor: '#292929' }}>
            <Typography variant="h6" gutterBottom>
                {assignment.title}
            </Typography>

            <Tabs value={tabIndex} onChange={handleTabChange} aria-label="assignment tabs">
                <Tab label="Details" sx={{ width: '50%' }} />
                <Tab label="Edit" sx={{ width: '50%' }} />
            </Tabs>
            ...
            <TabPanel value={tabIndex} index={0}>
                ...
                <AvatarGroup max={4}>
                    {assignment.students.map((student, index) => (
                        <Avatar key={index} alt={student.username} src={student.profile_picture}>
            ...
            <TabPanel value={tabIndex} index={1}>
                ...
                <TextField
                    ...
                    sx={{ mb: 2, ...inputStyle }}
                />
                <Button variant="contained" color="primary" onClick={handleEditAssignment}>
                    Save Changes
                </Button>
                <Button
                    variant="outlined"
